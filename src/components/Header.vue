        ...
        <div v-if="notification_open" class="notifictaion_list">
          ...
          <div class="notifictaion_content_wrappert">
            <div class="notification_content">
              <div class="notifictaion_item" v-for="(item, idx) in 10" :key="idx">
                <div class="top">Сегодня</div>
                <div class="bottom">
                  <img src="@/assets/images/avatar.svg" alt="">
                  <div class="right">
                    <div class="right_title">
                      <div class="title">Вы получили перевод</div>
                      <div class="time">12:00</div>
                    </div>
                    <right class="content">
                      Дмитрий Т. отправил вам <span>$320</span> на ваш кошелек
                    </right>
                  </div>
                </div>
              </div>
        ...
        navs: [
          ...
          },
          {
            ...
            svg: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="26" viewBox="0 0 24 26" fill="none">
                    <path d="M1.5 9.62834V16.36C1.5 18.8333 1.5 18.8333 3.83333 20.4083L10.25 24.1183C11.2183 24.6783 12.7933 24.6783 13.75 24.1183L20.1667 20.4083C22.5 18.8333 22.5 18.8333 22.5 16.3717V9.62834C22.5 7.16667 22.5 7.16667 20.1667 5.59167L13.75 1.88167C12.7933 1.32167 11.2183 1.32167 10.25 1.88167L3.83333 5.59167C1.5 7.16667 1.5 7.16667 1.5 9.62834Z" stroke="#A6A4B4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M12 16.5C13.933 16.5 15.5 14.933 15.5 13C15.5 11.067 13.933 9.50001 12 9.50001C10.067 9.50001 8.5 11.067 8.5 13C8.5 14.933 10.067 16.5 12 16.5Z" stroke="#A6A4B4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>`
          },
        ],
